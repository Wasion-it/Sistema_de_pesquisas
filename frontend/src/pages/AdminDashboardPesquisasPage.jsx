...
export function AdminDashboardPesquisasPage() {
  ...
  return (
    <div className="admin-view">
      <div className="admin-view-header">
        <div>
          <span className="eyebrow">Dashboard / Pesquisas</span>
          <h2>{greeting}, {user?.full_name?.split(' ')[0] ?? 'Administrador'}</h2>
          <p>
            Painel com leitura rápida dos indicadores consolidados das pesquisas, campanhas e respostas.
          </p>
        </div>
